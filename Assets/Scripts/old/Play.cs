...
namespace old
{
	public class Play : MonoBehaviour
	{
		...
		/// </summary>
		[SerializeField] private old.Entities.Tile tilePrefab;
		...
		/// </summary>
		[SerializeField] private LevelOld gameLevel;
		...
		private void GenerateTile(Vector2Int coordinates)
		{
			...
			else
			{
				...
				var cfgActorWeights = cfg.tilesConfig.Select(data => 
					data.GetWeightAtLevel(gameLevel)).ToList();
		...
		public void OnTileClicked(old.Entities.Tile tile)
		{
